...
#define GPBDIR    ((volatile unsigned long*)0x7c4a)
#define GPBSET    ((volatile unsigned long*)0x7f0a)
#define GPBCLEAR  ((volatile unsigned long*)0x7f0c)
#define GPBTOGGLE ((volatile unsigned long*)0x7f0e)

#define BLINK_PERIOD PICORTOS_DELAY_SEC(1)
#define BLINK_DELAY  PICORTOS_DELAY_MSEC(60)

#define LED_RED   (1ul << 2)
#define TICK      (1ul << 0)
